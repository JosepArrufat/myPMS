...
export const reservationsCheckInStatusIdx = index('idx_reservations_checkin_status').on(reservations.checkInDate, reservations.status);
export const reservationsCheckOutStatusIdx = index('idx_reservations_checkout_status').on(reservations.checkOutDate, reservations.status);
...
export const reservationRoomsDatesIdx = index('idx_reservation_rooms_dates').on(reservationRooms.checkInDate, reservationRooms.checkOutDate);
...
export const reservationRoomsTypeAvailabilityIdx = index('idx_reservation_rooms_type_availability').on(reservationRooms.roomTypeId, reservationRooms.checkInDate, reservationRooms.checkOutDate);
...
export const roomAssignmentsRoomDateUnique = uniqueIndex('idx_room_assignments_room_date_unique').on(roomAssignments.roomId, roomAssignments.date);
export const roomAssignmentsReservationIdx = index('idx_room_assignments_reservation').on(roomAssignments.reservationId);
export const roomAssignmentsRoomDateIdx = index('idx_room_assignments_room_date').on(roomAssignments.roomId, roomAssignments.date);
